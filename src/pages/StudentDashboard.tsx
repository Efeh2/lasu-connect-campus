    ...
    <ProtectedRoute requiredRole="student">
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-sm transition-colors duration-300">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <UserAvatar name={`${firstName} ${user?.user_metadata?.last_name || ''}`} role="student" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Welcome back, {firstName}!</h2>
            <p className="text-gray-600 dark:text-gray-400">Here's your academic progress and upcoming tasks.</p>
          </div>
